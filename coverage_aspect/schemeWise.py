        ...
        for st in data:
            ...
            for party in data[st]:
                ...
                if party == center:
                    ...
                    state_count_al+= get_state_article_count(scheme ,statDate, endDate, st)
                    total_count_al += get_toatl_article_count(scheme ,statDate, endDate)

                else:

                    state_count_nl += get_state_article_count(scheme ,statDate, endDate, st)
                    total_count_nl += get_toatl_article_count(scheme ,statDate, endDate)
...
print(x)
with open('relative_cvg_PDS_dataFrame', 'wb') as f:
    pickle.dump(x, f)
